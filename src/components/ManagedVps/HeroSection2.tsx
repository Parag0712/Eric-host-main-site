                    ...
                    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
                        <div className="max-w-2xl text-center mx-auto">
                            ...
                            <div className="mt-5 max-w-3xl">
                                <p className="text-lg text-gray-600 dark:text-neutral-400">Web hosting made easy & affordable, hosting services solution for successful personal and business websites.</p>
                            </div>

                            {/* <!-- Buttons --> */}
                            <div className="mt-8 gap-3 flex justify-center">
                                <a className="py-3 px-4 inline-flex items-center duration-300 gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primary text-white hover:bg-indigo-600 disabled:opacity-50 disabled:pointer-events-none" href="#">
                                    Get started
