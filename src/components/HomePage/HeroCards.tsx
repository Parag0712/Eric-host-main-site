...
export const HeroCards = () => {
    return (
        <div className="hidden lg:flex flex-row flex-wrap gap-8 relative  w-[400px] lg:w-[700px] h-[500px]">
            {/* Testimonial */}
            ...
            {/* Service */}
            <Card className="absolute w-[350px] -right-[10px] bottom-[45px]  drop-shadow-xl shadow-black/10 dark:shadow-white/10">
